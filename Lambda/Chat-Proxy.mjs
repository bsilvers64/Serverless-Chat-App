...
//  Loads details for a conversation, including participants and the timestamp of the last message.
...
// Loads the timestamp of the last message for multiple conversations.
async function loadConvosLast(ids) {
  const queryResults = ids.map((id) =>
    client.send(
      new QueryCommand({
        TableName: "Chat-Messages",
...
// Loads participants for multiple conversations.
